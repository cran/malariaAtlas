...
listPoints <- function(printed = TRUE, sourcedata, version = NULL) {
  ...
  lifecycle::deprecate_stop("1.6.0", "listPoints()", details = "The function 'listPoints' has been deprecated. Please switch to using listPRPointCountries for pr points, and listVecOccPointCountries for vector points.")
