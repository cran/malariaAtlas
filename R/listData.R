...
listData <- function(datatype, printed = TRUE, ...){
  ...
  lifecycle::deprecate_stop("1.6.0", "listData()", details = "The function 'listData' has been deprecated. Please switch to using listPRPointCountries for pr points, listVecOccPointCountries for vector points, listRaster for raster and listShp for shape.")
